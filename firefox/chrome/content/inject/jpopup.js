(function($) {
    ...
    function return_to_default() {
        ...
        $("#threebeats_fb_collapse").html("See what others are saying <div class='threebeats_sprite'><img class='threebeats_sprites threebeats_expand' src='chrome://threebeats/content/inject/images/sprite.png'/>");
    }
    ...
    function updatePopupData(strCelebrityName)
    {
        ...
        if (celebrityData.friends != null && celebrityData.friends != "" ) 
        {
           var strFB = '' +
                       ...
                       '   <div class="threebeats_sprite"><img class="threebeats_sprites threebeats_expand" src="chrome://threebeats/content/inject/images/sprite.png"/></div>' +
                       '</a>';
           $('#threebeats_fb_display_comments').empty();    
           ...
           if(celebrityData.friends.friend1.pic == null || celebrityData.friends.friend1.pic == "")
                imagePic = "chrome://threebeats/content/inject/images/defaults_img.png";
           else
           ...
           strHTML += '' +
               ...
               if(strSprite != '')
               {
                   ...
                   '           <img id="threebeats_fbvote1" class="threebeats_sprites ' + strSprite + '" src="chrome://threebeats/content/inject/images/sprite.png" alt="" />' +
                   '       </div>';
               }
                strHTML += '' +
    ...
    function ShowVote(strPostURL, comment) 
    {
 		try 
 		{
 			$.getJSON(strPostURL, function(data) {
                ...
                setTimeout(function () 
                        {
                            $("#" + popup_id).fadeOut(2000, return_to_default);
                            shown = false;
                            rank = "";
    ...
    function ShowNoError(commentText) {
        ...
        $("#threebeats_fb_display_comments").css({"float":"right","padding-right":"60px","position":"relative","top":"-35px"});
    ...
    function ShowError(msg) {
        ...
        $("#threebeats_submit_buttons").hide();
        $("#threebeats_tagline").hide();
        $("#threebeats_fb_display_comments").css({"float":"right","padding-right":"60px","position":"relative","top":"-25px"});
        $("#threebeats_mycomment").show();
...
function fbExpand() 
{
    if (!$("#threebeats_facebook_bg").is(":hidden")) {
       ...
       $("#threebeats_fb_collapse").html("See what others are saying <div class='threebeats_sprite'><img class='threebeats_sprites threebeats_expand' src='chrome://threebeats/content/inject/images/sprite.png'/>");
         ...
         $("#threebeats_fb_collapse").html("See what others are saying <div class='threebeats_sprite'><img class='threebeats_sprites threebeats_collapse' src='chrome://threebeats/content/inject/images/sprite.png'/>");
    }
}
